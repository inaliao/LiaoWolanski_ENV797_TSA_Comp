...
fourier_terms_1<-fourier(msts_deseason_training, K=c(2,4), h = 31)
#generate forecast
temp_forecast_1<-forecast(msts_temp_training, h = 31)
...
#generate fourier terms
fourier_terms_2<-fourier(msts_training, K=c(2,12), h = 31)
#generate forecast
temp_forecast_2<-forecast(msts_temp_training, h = 31)
#combine fourier terms and forecasts into a numeric matrix
...
NN_forecast_1<-forecast(NN_fit_1,
                        xreg=fourier(msts_training,K=c(2,4),h=31), 
                        h=31)
