...
#filter missing data
df_load_merge %>%
  filter(is.na(date)) #error: use other value to check missing data
df_temp_merge %>%
  filter(is.na(date)) 
df_humid_merge %>%
  filter(is.na(date)) 
...
```{r Export File}
here()
write.csv(df_load_processed, "Data/Processed/load_processed.csv", row.names = TRUE)
write.csv(df_temp_processed, "Data/Processed/temp_processed.csv", row.names = TRUE)
write.csv(df_humid_processed, "Data/Processed/humid_processed.csv", row.names = TRUE)
```
